...
const EmployeeChatSupport = ({ user }) => {
  ...
  const getRoleBadge = (roles) => {
    ...
    if (roles.includes('Super Admin')) return <span className="inline-block bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-xs font-semibold ml-2">Super Admin</span>;
    return null;
  };
...
export default EmployeeChatSupport; 